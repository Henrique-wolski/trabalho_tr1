...
def bit_paridade(quadros):
    ...
    for quadro in quadros:
        ...
        if paridade:
            quadros_alterados[-1].insert(2, '0')
        else:
            quadros_alterados[-1].insert(2, '1')
...
def checksum(quadros):
    ...
    for quadro in quadros:
        ...
        quadros_alterados[-1].insert(2, checksum_str)
...
def crc(quadros):
    ...
    for quadro in quadros:
        ...
        quadros_alterados[-1].insert(2, payload)
...
def hamming(quadros):
    ...
    for quadro in quadros:
        ...
        quadros_alterados[-1].insert(2, bits_hamming_str)
